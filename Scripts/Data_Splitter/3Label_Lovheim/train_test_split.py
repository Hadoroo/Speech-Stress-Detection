...
FEATURE_ROOT = os.path.join(BASE_FOLDER_PATH, "Processed")
SPLIT_PATH = os.path.join(BASE_FOLDER_PATH, "Split/3label/train_test")
...
for file in sorted(os.listdir(FEATURE_ROOT)):
    ...
    data.append({
        ...
        "emotion": emotion,
        "stress": stress,
        "label": 2 if stress == "High-stress" else 1 if stress == "Medium-stress" else 0
    })
